# Vantage Robotics — Synthetic Dataset Plan (BUILD_PLAN D2-M4, vision §26)

Target under diligence: **Vantage Robotics, Inc.** Deal: **Project Falcon** (`deal-falcon`).
...
2. The change-of-control termination right lives ONLY in
   `contract_meridian_logistics.pdf` §11.3; no other doc may grant or waive it.
...
|---|---|---|---|---|---|---|
| 1 | `contract_meridian_logistics.pdf` | native PDF | Legal | Meridian CoC termination right (§11.3); 3-year master services term | 2 | D3 finding smoke, Day-5 governed query, Day-8 keystone |
...
| 3 | `hr_roster_vantage.xlsx` | XLSX | HR | Dana Whitfield (VP Customer Success, Meridian account owner) resignation effective in 60 days | **finalized 3 (D3-M7)** (authored D2-M6) | Day-8 keystone |
...
| 6 | `amendment_2030.pdf` | native PDF | Legal | Extends TitanBridge exclusivity to 2030-06-30; lineage-linked to #5 via explicit `link_supersedes`; tests update-not-duplicate (vision §16 Day 7) | 5 (D5-M5) | D10 memory test, Day-7 scenario beat |
